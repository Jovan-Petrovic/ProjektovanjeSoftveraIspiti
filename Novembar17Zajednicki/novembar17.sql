...
MySQL - 10.4.11-MariaDB : Database - prosoftnov17
*********************************************************************
*/
...
insert  into `investicija`(`InvesticijaID`,`InvestitorID`,`KompanijaID`,`Datum`,`Iznos`) values 
(1,1,1,'2019-12-01',200000.00);
...
insert  into `investitor`(`InvestitorID`,`Naziv`,`Adresa`,`Username`,`Password`) values 
(1,'Venture Capital 1','Adresa 1','vc1','vc1'),
(2,'VCFON','Jove Ilica 154','fon','fon'),
(3,'HITEC VC','Adresa 2','hitec','hitec');
...
insert  into `kompanija`(`KompanijaID`,`Naziv`,`OblastPoslovanja`,`IPO`,`Tip`) values 
(1,'Google','Tech',1,'A'),
(2,'Uber','Tech',0,'A'),
(3,'Tesla','Car',1,'A'),
(4,'Atom','Car',0,'A'),
(5,'Beti','Lifestyle',0,'A');
